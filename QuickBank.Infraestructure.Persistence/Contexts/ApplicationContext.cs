    ...
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LoanEntity>().HasData(
                new LoanEntity { Id = 1, LoanNumber = "LN000001", Amount = 0, Deadline = DateTime.Parse("2025-01-15"), InterestRate = 5.0, Description = "Car loan", Status = 0, ApplicationDate = DateTime.Parse("2023-01-01"), AprovalDate = DateTime.Parse("2023-01-10"), UserId = "n8d7x-qsj3p-lf9b2-hu6zr-4579y" },
                new LoanEntity { Id = 2, LoanNumber = "LN000002", Amount = 0, Deadline = DateTime.Parse("2026-02-20"), InterestRate = 4.5, Description = "Home loan", Status = 0, ApplicationDate = DateTime.Parse("2023-02-01"), AprovalDate = DateTime.Parse("2023-02-15") },
                new LoanEntity { Id = 3, LoanNumber = "LN000003", Amount = 0, Deadline = DateTime.Parse("2024-03-10"), InterestRate = 6.0, Description = "Personal loan", Status = 0, ApplicationDate = DateTime.Parse("2023-03-01"), AprovalDate = DateTime.Parse("2023-03-05") },
                new LoanEntity { Id = 4, LoanNumber = "LN000004", Amount = 0, Deadline = DateTime.Parse("2025-04-25"), InterestRate = 5.5, Description = "Education loan", Status = 0, ApplicationDate = DateTime.Parse("2023-04-01"), AprovalDate = DateTime.Parse("2023-04-10") },
                new LoanEntity { Id = 5, LoanNumber = "LN000005", Amount = 0, Deadline = DateTime.Parse("2024-05-30"), InterestRate = 4.0, Description = "Medical loan", Status = 0, ApplicationDate = DateTime.Parse("2023-05-01"), AprovalDate = DateTime.Parse("2023-05-05") },
                new LoanEntity { Id = 6, LoanNumber = "LN000006", Amount = 0, Deadline = DateTime.Parse("2026-06-15"), InterestRate = 3.5, Description = "Business loan", Status = 0, ApplicationDate = DateTime.Parse("2023-06-01"), AprovalDate = DateTime.Parse("2023-06-10") },
                new LoanEntity { Id = 7, LoanNumber = "LN000007", Amount = 0, Deadline = DateTime.Parse("2025-07-20"), InterestRate = 5.0, Description = "Vacation loan", Status = 0, ApplicationDate = DateTime.Parse("2023-07-01"), AprovalDate = DateTime.Parse("2023-07-05") },
                new LoanEntity { Id = 8, LoanNumber = "LN000008", Amount = 0, Deadline = DateTime.Parse("2026-08-25"), InterestRate = 4.8, Description = "Renovation loan", Status = 0, ApplicationDate = DateTime.Parse("2023-08-01"), AprovalDate = DateTime.Parse("2023-08-10") },
                new LoanEntity { Id = 9, LoanNumber = "LN000009", Amount = 0, Deadline = DateTime.Parse("2025-09-15"), InterestRate = 4.2, Description = "Investment loan", Status = 0, ApplicationDate = DateTime.Parse("2023-09-01"), AprovalDate = DateTime.Parse("2023-09-05") },
                new LoanEntity { Id = 10, LoanNumber = "LN000010", Amount = 0, Deadline = DateTime.Parse("2026-10-30"), InterestRate = 5.3, Description = "Consolidation loan", Status = 0, ApplicationDate = DateTime.Parse("2023-10-01"), AprovalDate = DateTime.Parse("2023-10-05") }
            );
