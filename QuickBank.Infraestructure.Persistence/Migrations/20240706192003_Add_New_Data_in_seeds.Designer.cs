...
namespace QuickBank.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240706192003_Add_New_Data_in_seeds")]
    partial class Add_New_Data_in_seeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickBank.Core.Domain.Entities.Productos.CreditCardEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LimitCredit = 5000.0,
                            Status = 1,
                            UserId = "f294u-ewrdm-woj93-hj3dn-8937w"
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("QuickBank.Core.Domain.Entities.Productos.LoanEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LoanNumber = "LN000001",
                            Status = 1,
                            UserId = "n8d7x-qsj3p-lf9b2-hu6zr-4579y"
                        },
                        new
                        {
                            Id = 2,
